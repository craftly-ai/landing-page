...
const SalesFunnelSection = () => {
  ...
  let salesFunnelList = data.allWpPage.nodes.map(node => node.keapMarketing.salesFunnelList)
      ...
      <div className="container">
            <div className="row">
                <div className="col-md-12">
                  <h3 className="text-center" dangerouslySetInnerHTML={{ __html: salesFunnelTitle }} />
                </div>
            </div>
