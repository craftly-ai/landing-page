...
function ProductDescription() {
  ...
  let title = data.allWpPage.nodes[0].documentation.productDescription.title
  let description =
    data.allWpPage.nodes[0].documentation.productDescription.description
  let stepsTitle =
    data.allWpPage.nodes[0].documentation.productDescription.stepsTitle
  let stepsList =
    data.allWpPage.nodes[0].documentation.productDescription.stepsList
  let tipsTitle =
    data.allWpPage.nodes[0].documentation.productDescription.tipsTitle
  let tipsDescription =
    data.allWpPage.nodes[0].documentation.productDescription.tipsDescription
  let contentCreationsTitle =
    data.allWpPage.nodes[0].documentation.productDescription
      .contentCreationsTitle
