...
const EmailThankYou = () => {
  ...
  let title = data.allWpPage.nodes[0].documentation.thankYouEmail.title
  let description =
    data.allWpPage.nodes[0].documentation.thankYouEmail.description
  let stepsTitle =
    data.allWpPage.nodes[0].documentation.thankYouEmail.stepsTitle
  let stepsList = data.allWpPage.nodes[0].documentation.thankYouEmail.stepsList
  let tipsTitle = data.allWpPage.nodes[0].documentation.thankYouEmail.tipsTitle
  let tipsDescription =
    data.allWpPage.nodes[0].documentation.thankYouEmail.tipsDescription
  let contentCreationsTitle =
    data.allWpPage.nodes[0].documentation.thankYouEmail.contentCreationsTitle
